...
from ballet.assembly.concertod.components.openstack.nova import Nova 
...
node_name = f"node_nova{i}"
devops = f"DevOpsNova{i}"

ADDRESS = 'localhost'
MASTER_PORT = 3000
PORT =  MASTER_PORT + 10 * (i + 1) + 1
 
# instances
versions=["1", "2", "3"]
nova_worker = Nova(versions=versions)
...
if sat or i != 0:
    ...
    goals[nova_worker].append(StateReconfigurationGoal('deployedv3'))
